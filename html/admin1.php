...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="row button-section">
            <div class="col-md-6">
                <button class="btn btn-primary" onclick="window.location.href='admin.php'">Add User</button>
                ...
                <button class="btn btn-primary" onclick="addCourse()">
                    <class style="color: white;">Add Courses</a>
                </button>
                <button class="btn btn-primary" onclick="addBatch()">
                    <class style="color: white;">Add Batch</a>
                </button>
                <button class="btn btn-primary" onclick="addTeacher()">
                    <class style="color: white;">Add Teacher</a>
                </button>
            </div>
