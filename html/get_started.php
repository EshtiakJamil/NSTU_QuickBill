...
$isLoggedIn = isset($_SESSION['user_id']); // Replace 'user_id' with your session key for user identification

// Determine the next page for logged-in users
$nextPage = $isLoggedIn ? 'dashboard.php' : 'login.php'; // Replace 'dashboard.php' with the actual page for logged-in users
?>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= $nextPage ?>"><i class="fas fa-sign-in-alt"></i> <?= $isLoggedIn ? 'Dashboard' : 'Login' ?></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <a href="<?= $nextPage ?>" class="btn"><?= $isLoggedIn ? 'Dashboard' : 'Login' ?></a>
    </div>
