...
<nav class="navbar navbar-expand-lg navbar-custom">
    ...
    <div class="container mt-4">
        ...
        <div class="row button-section">
            <div class="col-md-6">
                <button class="btn btn-primary" onclick="window.location.href='createbill.php'">Create Bill</button>
    ...
    <script>
        ...
        function trackBill() {
            alert('Track Bill facility will be available soon');
        }
        function billHistory() {
            alert('Bill History button will work soon!');
        }
    </script>
